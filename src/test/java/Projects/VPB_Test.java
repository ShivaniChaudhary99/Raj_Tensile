...
public class VPB_Test 
{
	...
	@Test(priority=3)
	void VaibhavPalaceBankhedi() throws InterruptedException 
	{
		WebElement OpenImage =driver.findElement(By.xpath("//a[@title='Vaibhav palace Bankhedi Mandya pradesh']//i[@class='fa fa-arrows-alt']"));
	...
	void VPB() 
	{
	    WebElement VPB =driver.findElement(By.xpath("//a[@href='https://rajtensilestructure.com/portfolio/vaibhav-palace-bankhedi-mandya-pradesh/']//i[@class='fa fa-eye']"));
    	Actions a= new Actions(driver);
    	a.moveToElement(VPB).click().perform();
