...
public class AHDR_Test 
{
	...
	@Test(priority=3)
	void AnimalHusbandaryDepartmentRanchi() throws InterruptedException 
	{
		WebElement OpenImage =driver.findElement(By.xpath("//a[@title='Animal Husbandry Department Ranchi Jharkhand']//i[@class='fa fa-arrows-alt']"));
	...
	void AHDR() 
	{
	    WebElement AHDR =driver.findElement(By.xpath("//i[@class=\"fa fa-eye\"]"));
    	Actions a= new Actions(driver);
    	a.moveToElement(AHDR).click().perform();
